...
const pillars = [
  {
    icon: Brain,
    title: "We Speak 'Prompt'",
    description:
      "We understand the intent behind your AI prompts. We don't scoff at AI code; we embrace it as a foundation and respect the work you've already put in.",
  },
  {
    icon: Rocket,
  ...
  },
  {
    ...
    description:
      "No hostage situations. Once we fix or build your app, we hand over the keys (and the code). You are free to scale it, sell it, or hire others.",
  },
];
